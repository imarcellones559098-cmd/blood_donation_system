...
<body class="min-h-screen text-gray-800">
    ...
    <nav class="premium-nav text-white">
        <div class="max-w-6xl mx-auto px-4 py-3 flex justify-between items-center">
            <a href="<?php echo e(route('donor.dashboard')); ?>" class="flex items-center gap-2 font-extrabold text-xl tracking-tight">
                <span class="text-2xl drop-shadow-md">🩸</span> BloodDonate
            </a>
            <div class="flex items-center gap-2 text-sm font-medium">
                <a href="<?php echo e(route('donor.dashboard')); ?>"
                   class="nav-link <?php echo e(request()->routeIs('donor.dashboard') ? 'active' : 'text-red-100'); ?>">
                    Dashboard
                </a>
                 <a href="<?php echo e(route('donor.requests.index')); ?>"
                    class="nav-link <?php echo e(request()->routeIs('donor.requests.*') ? 'active' : 'text-red-100'); ?>">
                    Blood Requests
                </a>
                <a href="<?php echo e(route('donor.profile')); ?>"
                   class="nav-link <?php echo e(request()->routeIs('donor.profile') ? 'active' : 'text-red-100'); ?>">
                    My Profile
                </a>
                <form action="<?php echo e(route('logout')); ?>" method="POST" class="ml-4">
                    <?php echo csrf_field(); ?>
                    <button type="submit"
    ...
    <footer class="text-center text-gray-400 text-xs py-6 mt-10 border-t">
        &copy; <?php echo e(date('Y')); ?> Blood Donation Management System. All rights reserved.
    </footer>

</body></html><?php /**PATH C:\laravel\blood_donation_system\resources\views/layouts/donor.blade.php ENDPATH**/ ?>