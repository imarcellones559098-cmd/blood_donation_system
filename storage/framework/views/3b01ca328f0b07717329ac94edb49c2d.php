...
<body>
    <aside class="sidebar">
        ...
        <nav>
            ...
            <a href="<?php echo e(route('admin.donors')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.donors') ? 'active' : ''); ?>">
                <span class="icon">👥</span> Donors
            </a>
            <a href="<?php echo e(route('admin.requests.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.requests.*') ? 'active' : ''); ?>">
         ...
         <a href="<?php echo e(route('admin.donations.create')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.donations.*') ? 'active' : ''); ?>">
...
</html><?php /**PATH C:\laravel\blood_donation_system\resources\views/layouts/admin.blade.php ENDPATH**/ ?>