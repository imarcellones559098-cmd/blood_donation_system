...
<body>
    ...
    <section class="hero" id="home">
        <div class="hero-content">
            ...
            <div class="hero-buttons">
                <a href="<?php echo e(route('register')); ?>" class="btn-primary">🩸 Become a Donor</a>
                <a href="<?php echo e(route('login')); ?>" class="btn-secondary">Login to Dashboard</a>
            </div>
        </div>
    </section>
    ...
    <section class="cta-section" id="about">
        <div class="cta-box">
            ...
            <a href="<?php echo e(route('register')); ?>" class="btn-primary">Get Started — It's Free</a>
        </div>
    </section>
...
</html><?php /**PATH C:\laravel\blood_donation_system\resources\views/welcome.blade.php ENDPATH**/ ?>