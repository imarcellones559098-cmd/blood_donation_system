...
<div class="stats-grid">
    <div class="stat-card">
        ...
        <div class="stat-info">
            <div class="stat-value"><?php echo e($donors->count()); ?></div>
    ...
    <div class="stat-card">
        ...
        <div class="stat-info">
            <div class="stat-value"><?php echo e($donors->filter(fn($d) => $d->donorProfile && $d->donorProfile->blood_type)->pluck('donorProfile.blood_type')->unique()->count()); ?></div>
    ...
    <div class="stat-card">
        ...
        <div class="stat-info">
            <div class="stat-value"><?php echo e($donors->filter(fn($d) => $d->donorProfile && $d->donorProfile->blood_type && $d->donorProfile->contact_number && $d->donorProfile->gender)->count()); ?></div>
    ...
    <div class="stat-card">
        ...
        <div class="stat-info">
            <div class="stat-value"><?php echo e($donors->filter(fn($d) => !$d->donorProfile || !$d->donorProfile->blood_type || !$d->donorProfile->contact_number)->count()); ?></div>
...
<div class="section-header" style="align-items: flex-end; margin-bottom: 24px;">
    ...
    <div style="display: flex; align-items: center; gap: 12px; flex-wrap: wrap;">
        ...
        <select class="filter-select" id="bloodFilter" onchange="filterRows()">
            ...
            <?php $__currentLoopData = ['A+','A-','B+','B-','O+','O-','AB+','AB-']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <span class="count-badge" id="countBadge"><?php echo e($donors->count()); ?> donors</span>
    </div>
</div>
...
<div class="table-card">
    <table>
        ...
        <tbody id="donorTable">
            <?php $__empty_1 = true; $__currentLoopData = $donors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $donor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <?php
            ...
            <tr
                ...
                data-email="<?php echo e(strtolower($donor->email)); ?>"
                data-blood="<?php echo e($blood ?? ''); ?>"
                data-gender="<?php echo e($gender ?? ''); ?>"
            >
                <td>
                    <div class="donor-cell">
                        <div class="donor-avatar"><?php echo e($initials); ?></div>
                        <div>
                            <div class="donor-name"><?php echo e($donor->name); ?></div>
                            <div style="font-size:11px; color:#94a3b8; margin-top:2px; font-weight:600; letter-spacing:0.5px;">D-<?php echo e(str_pad($donor->id, 3, '0', STR_PAD_LEFT)); ?></div>
                        </div>
                    </div>
                </td>
                <td style="color:#475569; font-size:13px; font-weight:500;"><?php echo e($donor->email); ?></td>
                <td>
                    <?php if($blood): ?>
                        <span class="blood-pill"><?php echo e($blood); ?></span>
                    <?php else: ?>
                        <span class="blood-pill blood-empty">—</span>
                    <?php endif; ?>
                </td>
                <td style="color:#475569; font-size:13px; font-weight:500;"><?php echo e($contact ?? '—'); ?></td>
                <td>
                    <span class="gender-badge <?php echo e($genderClass); ?>"><?php echo e($gender ?? '—'); ?></span>
                </td>
                <td>
                    <span class="status-pill <?php echo e($statusClass); ?>">
                        <span class="dot" style="background:<?php echo e($dotColor); ?>"></span>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laravel\blood_donation_system\resources\views/admin/donors.blade.php ENDPATH**/ ?>