...
<div class="max-w-xl mx-auto">
    <h2 class="text-2xl font-bold text-red-700 mb-6">Edit Donation</h2>

    <div class="bg-white rounded-lg shadow p-6">
        <form action="{{ route('donor.update', $donation->id) }}" method="POST" class="space-y-5">
            @csrf @method('PUT')
            ...
            <div>
                ...
                <textarea name="notes" rows="3"
                          class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-red-400">{{ $donation->notes }}</textarea>
            </div>
